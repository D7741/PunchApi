        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveReason = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PunchRecordId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<long>(type: "INTEGER", nullable: false),
                    PunchInTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    PunchOutTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ModifiedByManagerId = table.Column<long>(type: "INTEGER", nullable: true),
                    ModificationReason = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByManagerId = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PunchRecords_ModifiedByManagerId",
                table: "PunchRecords",
                column: "ModifiedByManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_PunchRecords_UserId_PunchInTime",
                table: "PunchRecords",
                columns: new[] { "UserId", "PunchInTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_CreatedByManagerId",
                table: "Schedules",
